...
public class UpdateCategoryInputValidator : AbstractValidator<UpdateCategoryInput>
{
    ...
    public UpdateCategoryInputValidator(ICategoryRepository categoryRepository, IStringLocalizer<No1Resource> l)
    {
    ...
    private async Task<bool> NotAlreadyExistCategory(UpdateCategoryInput input, CancellationToken cancellationToken)
    {
