...
public class UpdateCurrentUserInputValidator : AbstractValidator<UpdateCurrentUserInput>
{
    ...
    public UpdateCurrentUserInputValidator(IStringLocalizer<No1Resource> l)
    {
        _l = l;
